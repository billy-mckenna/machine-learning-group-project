...
save_plot("cross_validation/plots/ridge_cv_order_dataset_" + data + ".jpg", order_range, title_order, x_label_order, mean_mse_order, std_mse_order, 
mean_mae_order, std_mae_order, mean_r2_order, std_r2_order)

#Cross Validation for C value selection
C_range = [0.1, 0.5, 1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90, 100]
...
save_plot("cross_validation/plots/ridge_cv_penalty_dataset_" + data + ".jpg", C_range, title_C, x_label_C, mean_mse_C, std_mse_C, 
