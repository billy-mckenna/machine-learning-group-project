...
save_plot("cross_validation/plots/lasso_cv_order.jpg", order_range, title_order, x_label_order, mean_mse_order, std_mse_order, mean_mae_order, std_mae_order)
...
save_plot("cross_validation/plots/lasso_cv_penalty.jpg", C_range, title_C, x_label_C, mean_mse_C, std_mse_C, mean_mae_C, std_mae_C)
print("Plots saved!")
